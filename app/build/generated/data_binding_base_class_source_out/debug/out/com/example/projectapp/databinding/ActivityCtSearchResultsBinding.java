...
public final class ActivityCtSearchResultsBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView arrowLbl;
  ...
  @NonNull
  public final TextView lblDestiny;
  ...
  public static ActivityCtSearchResultsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.arrowLbl;
      TextView arrowLbl = rootView.findViewById(id);
      if (arrowLbl == null) {
        break missingId;
      }
      ...
      id = R.id.lblDestiny;
      TextView lblDestiny = rootView.findViewById(id);
      if (lblDestiny == null) {
        break missingId;
      }

      id = R.id.lblOrigin;
      TextView lblOrigin = rootView.findViewById(id);
      if (lblOrigin == null) {
        break missingId;
      }
